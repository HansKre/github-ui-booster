...
const featuresSchema = object({
  ...
  aiCodeSummary: boolean().default(true),
  ...
  descriptionTemplate: boolean().default(true),
  persistToUserProfile: boolean().default(false),
  prTitleFromJira: boolean().default(true),
  randomReviewer: boolean().default(true),
